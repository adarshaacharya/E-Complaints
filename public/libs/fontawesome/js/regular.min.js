...
!(function () {
  ...
  try {
    ...
    typeof document !== 'undefined' && (z = document);
  } catch (c) {}
  const h = (c.navigator || {}).userAgent;
  const v = void 0 === h ? '' : h;
  const l = c;
  const m = z;
  const s = (l.document,
  ...
  const H = a[s];
  function V(c, v) {
    const z = (arguments.length > 2 && void 0 !== arguments[2]
      ? arguments[2]
      : {}
    ).skipHooks;
    const h = void 0 !== z && z;
    const l = Object.keys(v).reduce((c, z) => {
      const h = v[z];
      return h.icon ? (c[h.iconName] = h.icon) : (c[z] = h), c;
    }, {});
    typeof H.hooks.addPack !== 'function' || h
          ...
          typeof Object.getOwnPropertySymbols === 'function'
              && (z = z.concat(
                Object.getOwnPropertySymbols(m).filter(
                  (c) => Object.getOwnPropertyDescriptor(m, c).enumerable,
                ),
              )),
          z.forEach((c) => {
            let z;
