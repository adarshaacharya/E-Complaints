...
!(function () {
  ...
  const H = s[m];
  function V(c, v) {
    const h = (arguments.length > 2 && void 0 !== arguments[2]
      ? arguments[2]
      : {}
    ).skipHooks;
    const l = void 0 !== h && h;
    const z = Object.keys(v).reduce((c, h) => {
      const l = v[h];
        ...
        for (let c = 1; c < arguments.length; c++) {
          var a = arguments[c] != null ? arguments[c] : {};
            ...
            "function" ===
              ...
              (c) => Object.getOwnPropertyDescriptor(a, c).enumerable,
                  ),
          )),
          h.forEach((c) => {
            var h;
