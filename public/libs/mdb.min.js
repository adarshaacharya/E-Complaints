...
jQuery.extend(jQuery.easing, {
  ...
  easeInOutCubic(t, e, n, i, a) {
      return (e /= a / 2) < 1
        ? (i / 2) * e * e * e + n
        : (i / 2) * ((e -= 2) * e * e + 2) + n;
    },
  easeInQuart(t, e, n, i, a) {
  ...
  easeInQuint(t, e, n, i, a) {
      return i * (e /= a) * e * e * e * e + n;
    },
  easeOutQuint(t, e, n, i, a) {
  ...
  easeInCirc(t, e, n, i, a) {
      return -i * (Math.sqrt(1 - (e /= a) * e) - 1) + n;
    },
  easeOutCirc(t, e, n, i, a) {
  ...
  easeInOutElastic(t, e, n, i, a) {
      var r = 1.70158;
      let o = 0;
    var s = i;
      if (e == 0) return n;
      if ((e /= a / 2) == 2) return n + i;
  ...
  easeInBack(t, e, n, i, a, r) {
      return (
        void 0 == r && (r = 1.70158), i * (e /= a) * e * ((r + 1) * e - r) + n
      );
    },
  easeOutBack(t, e, n, i, a, r) {
      return (
        void 0 == r && (r = 1.70158),
    ...
    if (!t.jQuery) {
      ...
      (n.extend = function () {
        ...
        for (
          ...
          u > l;
          l++
        ) if ((r = arguments[l]) != null) for (a in r) {
            { (t = s[a]),
            s !== (i = r[a])
      ...
      (n.fn = n.prototype = {
        ...
        position: function () {
          ...
          let e = this[0];
                var t = t.apply(e);
          let i = this.offset();
                let a = /^(?:body|html)$/i.test(t.nodeName)
            ? { top: 0, left: 0 }
            : n(t).offset();
          return (
    ...
    return (function (t, e, n, i) {
      ...
      function o(t, n, i, a) {
        ...
        function h() {
          ...
          (t != n || i != a)
                  && (function () {
                    for (let e = 0; v > e; ++e) w[e] = l(e * b, t, i);
                  }());
        }
        var f = 4;
              var p = 0.001;
              ...
              var v = 11;
              var b = 1 / (v - 1);
              var y = 'Float32Array' in e;
        if (arguments.length !== 4) return !1;
        for (let x = 0; x < 4; ++x) if (
                    ...
                    : l(
                      (function (e) {
                        ...
                        var o = n + ((e - w[--a]) / (w[a + 1] - w[a])) * b;
                            var s = u(o, t, i);
                        return s >= p ? c(e, o) : s == 0 ? o : d(e, n, n + b);
                      }(e)),
                      n,
                      a,
                    )
          ...
          f.isString(t)
            ...
            : (n =                    f.isArray(t) && t.length === 1
                      ...
                      : f.isArray(t) && t.length === 2
                        ...
                        : !(!f.isArray(t) || t.length !== 4) && o.apply(null, t)),
          !1 === n
      ...
      function l(t) {
        if (t) {
          ...
          for (let a = 0; n > a; a++) if (v.State.calls[a]) {
              ...
              for (
                ...
                if (r(S)) {
                  ...
                  if (
                    ...
                    y.setPropertyValue(S, 'display', d.display);
                  }
                  for (let M in (d.visibility !== i
                        && "hidden" !== d.visibility
                        && y.setPropertyValue(S, 'visibility', d.visibility),
                  k)) if ('element' !== M) {
                      var P;
                            var T = k[M];
                            var A = f.isString(T.easing)
                          ? v.Easings[T.easing]
                          : T.easing;
                      if (m === 1) P = T.endValue;
                      else {
                      ...
                      if (((T.currentValue = P), 'tween' === M)) g = P;
                        ...
                        if (y.Hooks.registered[M]) {
                          var _ = y.Hooks.getRoot(M);
                                var D = r(S).rootPropertyValueCache[_];
      ...
      function u(t, e) {
        ...
        for (
          ...
          if (
            ...
            var f = !1;
            c.each(y.Lists.transforms3D, (t, e) => {
              var n = /^scale/.test(e) ? 1 : 0;
                    var a = r(h).transformCache[e];
          ...
          r(h)
                  && !0 === o.loop
                  && !e
                  && (c.each(r(h).tweensContainer, (t, e) => {
                    /^rotate/.test(t)
        ...
        v.State.calls[t] = !1;
        for (let p = 0, g = v.State.calls.length; g > p; p++) if (!1 !== v.State.calls[p]) {
            l = !0;
            break;
          }
        !1 === l
        ...
        var b = (function () {
          ...
          function n(n, i) {
            var a = { dx: n.v, dv: t(n) };
                  ...
                  var o = e(n, 0.5 * i, r);
                  var s = e(n, i, o);
                  var l = (1 / 6) * (a.dx + 2 * (r.dx + o.dx) + s.dx);
                  var u = (1 / 6) * (a.dv + 2 * (r.dv + o.dv) + s.dv);
            return (n.x += l * i), (n.v += u * i), n;
          }
          return function t(e, i, a) {
            var r;
                  var o;
                  var s;
                  var l = { x: -1, v: 0, tension: null, friction: null };
                  var u = [0];
                  var c = 0;
            for (
              e = parseFloat(e) || 500,
...
p;
          ...
          setPropertyValue: function (t, n, i, a, o) {
            ...
            if ('scroll' === n) o.container
              ...
              else r(t) && r(t).isSVG && y.Names.SVGAttribute(n)
                  ? t.setAttribute(n, i)
                  : (t.style[s] = i);
              v.debug >= 2
          ...
          flushTransformCache: function (t) {
            ...
            if (
              ...
              var a; var 
o;
              c.each(r(t).transformCache, (e) => {
                return (
                  (a = r(t).transformCache[e]),
                  "transformPerspective" === e
                    ? ((o = a), !0)
                    : (d === 9 && 'rotateZ' === e && (e = 'rotate'),
                    void (n += `${e + a  } `))
                );
              }),
              o && (n = 'perspective' + o + ' ' + n);
...
i;
              ...
              function g() {
                ...
                if (a && i) (l.emToPx = L.lastEmToPx),
                  ...
                  (l.percentToPxWidth = L.lastPercentToPxWidth =                          (parseFloat(
                            y.getPropertyValue(u, 'width', null, !0),
                          ) || 1) / s),
                  (l.percentToPxHeight = L.lastPercentToPxHeight =                          (parseFloat(
                            y.getPropertyValue(u, 'height', null, !0),
                          ) || 1) / s),
                  (l.emToPx = L.lastEmToPx =                          (parseFloat(y.getPropertyValue(u, 'paddingLeft'))
                            || 1) / s),
                  t.myParent.removeChild(u);
                }
                return (
                  null === L.remToPx
                        && (L.remToPx =                          parseFloat(y.getPropertyValue(n.body, 'fontSize'))
                          || 16),
                  null === L.vwToPx
              ...
              if ('scroll' === P) {
                var x;
                      var k;
                      var M;
                      var A = /^x$/i.test(u.axis) ? "Left" : "Top";
                      var I = parseFloat(u.offset) || 0;
                u.container
                  ? f.isWrapped(u.container) || f.isNode(u.container)
                    ? ((u.container = u.container[0] || u.container),
                    (M =                            (x = u.container['scroll' + A])
                            + c(o).position()[A.toLowerCase()]
                            + I))
                    : (u.container = null)
                  : ((x =                          v.State.scrollAnchor[v.State['scrollProperty' + A]]),
                  (k =                          v.State.scrollAnchor[
                            v.State[
                ...
                for (let O in (r(o).tweensContainer
                      && !0 === r(o).isAnimating
                ...
                b)) {
                  ...
                  if (
                    ...
                    else if (q !== j && E !== 0) if (z === 0) j = q;
                      else {
                        a = a || g();
                        var U =                              /margin|padding|left|right|width|text|word|letter/i.test(
                                O,
                              )
                              || /X$/.test(O)
                              || "x" === O
          ...
          if (
            ...
            if (!/^(stop|finish)$/i.test(b) && !c.isPlainObject(w)) {
              w = {};
              for (let M = p + 1; M < arguments.length; M++) f.isArray(arguments[M])
  ...
  }())(
    {
          ...
          e.exports = {
            ...
            percentString: function (t, e) {
              ...
              var n = Math.round((t[0] / 255) * 100);
                  var i = Math.round((t[1] / 255) * 100);
                  var a = Math.round((t[2] / 255) * 100);
              return 'rgb(' + n + '%, ' + i + '%, ' + a + '%)';
            },
            percentaString: l,
      ...
      3: [
        function (t, e, n) {
          ...
          (r.prototype = {
            ...
            greyscale: function () {
              var t = this.values.rgb;
                  var e = 0.3 * t[0] + 0.59 * t[1] + 0.11 * t[2];
            ...
            mix: function (t, e) {
              var n = t;
                  var i = void 0 === e ? 0.5 : e;
                  var a = 2 * i - 1;
                  var r = this.alpha() - n.alpha();
                  var o = ((a * r == -1 ? a : (a + r) / (1 + a * r)) + 1) / 2;
                  var s = 1 - o;
              return this.rgb(
                o * this.red() + s * n.red(),
            ...
            clone: function () {
              var t;
                  ...
                  var i = this.values;
                  var a = n.values;
              for (let o in i) i.hasOwnProperty(o)
                    && ((t = i[o]),
          ...
          (r.prototype.setValues = function (t, e) {
            ...
            for (n = 0; n < t.length; n++) (a = Math.max(0, Math.min(s[t][n], r[t][n]))),
              (r[t][n] = Math.round(a));
            for (let c in o) c !== t && (r[c] = i[t][c](r[t]));
            return !0;
          }),
        ...
        function (t, e, n) {
          ...
          function m(t) {
            ...
            return (
              ...
              (e =                  (e = 3.2406 * a + -1.5372 * r + -0.4986 * o) > 0.0031308
          ...
          var C = {
              ...
              var M = {};
          for (let P in C) M[JSON.stringify(C[P])] = P;
        },
        {},
      ],
      5: [
          ...
          for (let r in i) {
            ...
            (a[s] = a[s] || {})[l] = a[r] = (function (t) {
              return function (e) {
                ...
                for (let a = 0; a < n.length; a++) n[a] = Math.round(n[a]);
                return n;
              };
            }(r));
          }
      ...
      7: [
        function (t, e, n) {
          ...
          t(14)(i);
          var a = t(50);
          for (let r in a) a.hasOwnProperty(r) && i.plugins.register(a[r]);
            ...
            (t.controllers.bar = t.DatasetController.extend({
              ...
              updateElement: function (t, e, n) {
                var i = this;
                      ...
                      var s = i.getDataset();
                      var l = t.custom || {};
                      var u = a.options.elements.rectangle;
              ...
              updateElementGeometry: function (t, e, n) {
                var i = this;
                      var a = t._model;
                      var r = i.getValueScale();
                      var o = r.getBasePixel();
                      var s = r.isHorizontal();
                      var l = i._ruler || i.getRuler();
                      var u = i.calculateBarValuePixels(i.index, e);
                      var c = i.calculateBarIndexPixels(i.index, e, l);
                (a.horizontal = s),
                (a.base = n ? o : u.base),
              ...
              _getStacks: function (t) {
                var e;
                      var n;
                      var i = this.chart;
                      var a = this.getIndexScale().options.stacked;
                      var r = void 0 === t ? i.data.datasets.length : t + 1;
                      var o = [];
                for (e = 0; e < r; ++e) (n = i.getDatasetMeta(e)).bar
                        && i.isDatasetVisible(e)
                        && (!1 === a
                          || (!0 === a && o.indexOf(n.stack) === -1)
                          || (void 0 === a
                            && (void 0 === n.stack
                              || -1 === o.indexOf(n.stack))))
                        && o.push(n.stack);
              ...
              getRuler: function () {
                var t;
                      ...
                      var i = this.getStackCount();
                      var a = this.index;
                      var o = n.isHorizontal();
                      var s = o ? n.left : n.top;
                      var l = s + (o ? n.width : n.height);
                      var u = [];
                ...
                return {
                  min: r.isNullOrUndef(n.options.barThickness)
                    ? (function (t, e) {
                      ...
                      for (a = 0, r = s.length; a < r; ++a) (i = t.getPixelForTick(a)),
              ...
              calculateBarValuePixels: function (t, e) {
                var n;
                      ...
                      var l = this.chart;
                      var u = this.getMeta();
                      var c = this.getValueScale();
                      var d = l.data.datasets;
                      var h = c.getRightValue(d[t].data[e]);
                      var f = c.options.stacked;
                      var p = u.stack;
                      var g = 0;
                if (f || (void 0 === f && void 0 !== p)) for (n = 0; n < t; ++n) (i = l.getDatasetMeta(n)).bar
                          && i.stack === p
              ...
              calculateBarIndexPixels: function (t, e, n) {
                var i = n.scale.options;
                      ...
                      var o = this.getStackIndex(t, this.getMeta().stack);
                      var s = a.start + a.chunk * o + a.chunk / 2;
                      var l = Math.min(
            ...
            t.controllers.bubble = t.DatasetController.extend({
              ...
              updateElement: function (t, e, n) {
                var i = this;
                      ...
                      var l = i._resolveElementOptions(t, e);
                      ...
                      var h = n ? s.getBasePixel() : s.getPixelForValue(u, e, c);
                (t._xScale = o),
                (t._yScale = s),
                (t._options = l),
                (t._datasetIndex = c),
              ...
              _resolveElementOptions: function (t, e) {
                var n;
                      ...
                      var a;
                      var o = this.chart;
                      var s = o.data.datasets[this.index];
                      var l = t.custom || {};
                      var u = o.options.elements.point;
                      var c = r.options.resolve;
                      var d = s.data[e];
                      var h = {};
                      var f = {
                        chart: o,
          ...
          i._set('doughnut', {
            ...
            legendCallback: function (t) {
              ...
              var n = t.data;
                  var i = n.datasets;
                  var a = n.labels;
              if (i.length) for (let r = 0; r < i[0].data.length; ++r) e.push(
            ...
            legend: {
                  ...
                  return e.labels.length && e.datasets.length
                    ? e.labels.map((n, i) => {
                      var a = t.getDatasetMeta(0);
                            ...
                            var s = a.data[i];
                            var l = (s && s.custom) || {};
                            var u = r.valueAtIndexOrDefault;
                            var c = t.options.elements.arc;
                      return {
                        text: n,
              ...
              onClick: function (t, e) {
                var n;
                    ...
                    var r = e.index;
                    var o = this.chart;
                for (n = 0, i = (o.data.datasets || []).length; n < i; ++n) (a = o.getDatasetMeta(n)).data[r]
            ...
            t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
              {
                ...
                update: function (t) {
                  var e = this;
                        ...
                        var i = n.chartArea;
                        var a = n.options;
                        var o = a.elements.arc;
                        var s = i.right - i.left - o.borderWidth;
                        var l = i.bottom - i.top - o.borderWidth;
                        var u = Math.min(s, l);
                        var c = { x: 0, y: 0 };
                        var d = e.getMeta();
                        var h = a.cutoutPercentage;
                        var f = a.circumference;
                  if (f < 2 * Math.PI) {
                    var p = a.rotation % (2 * Math.PI);
                          ...
                          var m = { x: Math.cos(p), y: Math.sin(p) };
                          var v = { x: Math.cos(g), y: Math.sin(g) };
                          var b =
                            (p <= 0 && g >= 0) ||
                ...
                updateElement: function (t, e, n) {
                  var i = this;
                        ...
                        var g = n && l.animateScale ? 0 : i.innerRadius;
                        var m = n && l.animateScale ? 0 : i.outerRadius;
                        var v = r.valueAtIndexOrDefault;
                  r.extend(t, {
                  ...
                  var b = t._model;
                        var y = t.custom || {};
                        var x = r.valueAtIndexOrDefault;
                        var w = this.chart.options.elements.arc;
            ...
            t.controllers.line = t.DatasetController.extend({
              ...
              update: function (t) {
                var n;
                      ...
                      var l = s.dataset;
                      var u = s.data || [];
                      var c = o.chart.options;
                      var d = c.elements.line;
                      var h = o.getScaleForId(s.yAxisID);
                      var f = o.getDataset();
                      var p = e(f, c);
                for (
                  p
              ...
              updateElement: function (t, e, n) {
                var i;
                      ...
                      var d = u.data[e];
                      var h = o.getScaleForId(s.yAxisID);
                      var f = o.getScaleForId(s.xAxisID);
                      var p = o.chart.options.elements.point;
                void 0 !== u.radius
              ...
              calculatePointY: function (t, e, n) {
                var i;
                      ...
                      var o = this.chart;
                      var s = this.getMeta();
                      var l = this.getScaleForId(s.yAxisID);
                      var u = 0;
                      var c = 0;
              ...
              updateBezierControlPoints: function () {
                ...
                else for (t = 0, e = s.length; t < e; ++t) (n = s[t]._model),
                    (i = r.splineCurve(
                ...
                if (this.chart.options.elements.line.capBezierPoints) for (t = 0, e = s.length; t < e; ++t) ((n = s[t]._model).controlPointPreviousX = l(
            ...
            legend: {
                ...
                generateLabels: function (t) {
                  ...
                  return e.labels.length && e.datasets.length
                    ? e.labels.map((n, i) => {
                      var a = t.getDatasetMeta(0);
                            var o = e.datasets[0];
                            var s = a.data[i].custom || {};
                            var l = r.valueAtIndexOrDefault;
                            var u = t.options.elements.arc;
                      return {
                        text: n,
              ...
              onClick: function (t, e) {
                var n;
                    ...
                    var r = e.index;
                    var o = this.chart;
                for (n = 0, i = (o.data.datasets || []).length; n < i; ++n) (a = o.getDatasetMeta(n)).data[r].hidden = !a.data[r]
                    .hidden;
                o.update();
              },
            },
            ...
            t.controllers.polarArea = t.DatasetController.extend({
              ...
              update: function (t) {
                var e;
                      ...
                      var o = a.getDataset();
                      var s = a.getMeta();
                      var l = a.chart.options.startAngle || 0;
                      var u = (a._starts = []);
                      var c = (a._angles = []);
                for (
                  a._updateRadius(),
              ...
              _updateRadius: function () {
                ...
                (e.radiusLength =                        (e.outerRadius - e.innerRadius)
            ...
            t.controllers.radar = t.DatasetController.extend({
              ...
              update: function (t) {
                var e = this;
                      ...
                      var o = i.custom || {};
                      var s = e.getDataset();
                      var l = e.chart.options.elements.line;
                      var u = e.chart.scale;
                void 0 !== s.tension
              ...
              updateElement: function (t, e, n) {
                var i = this;
                      ...
                      var o = i.getDataset();
                      var s = i.chart.scale;
                      var l = i.chart.options.elements.point;
                      var u = s.getPointPositionForValue(e, o.data[e]);
                void 0 !== o.radius
        ...
        function (t, e, n) {
          ...
          (e.exports = {
            ...
            cancelAnimation: function (t) {
              var e = a.findIndex(this.animations, (e) => {
                return e.chart === t;
              });
              -1 !== e
            ...
            requestAnimationFrame: function () {
              var t = this;
              null === t.request
                    && (t.request = a.requestAnimFrame.call(window, () => {
            ...
            advance: function (t) {
              for (var e, n, i = this.animations, r = 0; r < i.length;) (n = (e = i[r]).chart),
            ...
            o.extend(t.prototype, {
              ...
              resize: function (t) {
                var e = this;
                      var n = e.options;
                      var i = e.canvas;
                      var a = (n.maintainAspectRatio && e.aspectRatio) || null;
                      var r = Math.max(0, Math.floor(o.getMaximumWidth(i)));
                      var s = Math.max(
                    0,
              ...
              buildOrUpdateScales: function () {
                var t = this;
                      ...
                      var i = t.scales || {};
                      var a = [];
                      var r = Object.keys(i).reduce((t, e) => {
                    return (t[e] = !1), t;
                  }, {});
                n.scales
                      && (a = a.concat(
                        (n.scales.xAxes || []).map((t) => {
                          return {
                            options: t,
                            dtype: 'category',
                            dposition: 'bottom',
                ...
                o.each(a, (n) => {
                  var a = n.options;
                          var s = a.id;
                          var l = o.valueOrDefault(a.type, n.dtype);
                  e(a.position) !== e(n.dposition)
                          && (a.position = n.dposition),
                  (r[s] = !0);
                  var u = null;
                  if (s in i && i[s].type === l) ((u = i[s]).options = a),
                    (u.ctx = t.ctx),
                    (u.chart = t);
                  else {
              ...
              drawDataset: function (t, e) {
                var n = this.getDatasetMeta(t);
                      var i = { meta: n, index: t, easingValue: e };
              ...
              destroyDatasetMeta: function (t) {
                var e = this.id;
                      var n = this.data.datasets[t];
                      var i = n._meta && n._meta[e];
              ...
              updateHoverStyle: function (t, e, n) {
                var i;
                      var a;
                      var r;
                      var o = n ? 'setHoverStyle' : 'removeHoverStyle';
                for (a = 0, r = t.length; a < r; ++a) (i = t[a])
            ...
            i.extend(t.DatasetController.prototype, {
              ...
              linkScales: function () {
                var t = this;
                      var e = t.getMeta();
                      var n = t.getDataset();
                (e.xAxisID !== null && e.xAxisID in t.chart.scales)
              ...
              setHoverStyle: function (t) {
                var e = this.chart.data.datasets[t._datasetIndex];
                      var n = t._index;
                      var a = t.custom || {};
                      var r = i.valueAtIndexOrDefault;
                      var o = i.getHoverColor;
                      var s = t._model;
                (t.$previousStyle = {
      ...
      28: [
        function (t, e, n) {
          ...
          e.exports = function () {
            ...
            function e(t) {
              return void 0 !== t && t !== null && 'none' !== t;
            }
            function n(n, i, a) {
              var o = document.defaultView;
                  var s = r._getParentNode(n);
                  var l = o.getComputedStyle(n)[i];
                  var u = o.getComputedStyle(s)[i];
                  var c = e(l);
                  var d = e(u);
            ...
            (r.splineCurve = function (t, e, n, i) {
              var a = t.skip ? e : t;
                    ...
                    var u = s / (s + l);
                    var c = l / (s + l);
                    var d = i * (u = isNaN(u) ? 0 : u);
                    var h = i * (c = isNaN(c) ? 0 : c);
              return {
                previous: {
                  x: r.x - d * (o.x - a.x),
                  y: r.y - d * (o.y - a.y),
            ...
            (r.splineCurveMonotone = function (t) {
              ...
              for (e = 0; e < h; ++e) if (!(i = d[e]).model.skip) {
                  if (
                    ...
                    i.deltaK = f !== 0 ? (a.model.y - i.model.y) / f : 0;
                  }
                  !n || n.model.skip
                    ? (i.mK = i.deltaK)
                    : !a || a.model.skip
                ...
                i.model.skip
                        ...
                        || (r.almostEquals(i.deltaK, 0, this.EPSILON)
                          ...
                          (u = Math.pow(o, 2) + Math.pow(s, 2)) <= 9
                              ...
                              (i.mK = o * l * i.deltaK),
                              (a.mK = s * l * i.deltaK))));
              for (e = 0; e < h; ++e) (i = d[e]).model.skip
                      || ((n = e > 0 ? d[e - 1] : null),
                      (a = e < h - 1 ? d[e + 1] : null),
                      n
                        && !n.model.skip
            ...
            (r.getRelativePosition = function (t, e) {
              ...
              var u = parseFloat(r.getStyle(o, 'padding-left'));
                    var c = parseFloat(r.getStyle(o, "padding-top"));
                    var d = parseFloat(r.getStyle(o, "padding-right"));
                    var h = parseFloat(r.getStyle(o, "padding-bottom"));
                    var f = s.right - s.left - u - d;
                    var p = s.bottom - s.top - c - h;
              return {
                x: (n = Math.round(
            ...
            (r.retinaScale = function (t, e) {
              var n = (t.currentDevicePixelRatio =                    e
            ...
            (r.longestText = function (t, e, n, i) {
              ...
              var l = o.length / 2;
              if (l > n.length) {
                for (let u = 0; u < l; u++) delete a[o[u]];
                o.splice(0, l);
              }
              return s;
            }),
 ...
 26: 26, 3: 3, 34: 34, 46: 46 
      ...
      29: [
        function (t, e, n) {
          ...
          function r(t, e) {
            var n; var i; var a; var r; var 
o;
            for (i = 0, r = t.data.datasets.length; i < r; ++i) if (t.isDatasetVisible(i)) for (
          ...
          function u(t, e, n) {
            ...
            n.axis = n.axis || 'x';
            var r = l(n.axis);
                var u = n.intersect ? o(t, i) : s(t, i, !1, r);
                var c = [];
            return u.length
          ...
          e.exports = {
            modes: {
              ...
              nearest: function (t, e, n) {
                ...
                n.axis = n.axis || 'xy';
                var r = l(n.axis);
                    var o = s(t, i, n.intersect, r);
                return (
                  o.length > 1
                      && o.sort((t, e) => {
                        let n = t.getArea() - e.getArea();
                        return (
                          n === 0 && (n = t._datasetIndex - e._datasetIndex), n
                        );
                      }),
                  o.slice(0, 1)
                );
            ...
            update: function (t, e, n) {
              if (t) {
                var o = t.options.layout || {};
                    var s = i.options.toPadding(o.padding);
                    var l = s.left;
                    var u = s.right;
                    var c = s.top;
                    var d = s.bottom;
                    var h = a(t.boxes, "left");
                    var f = a(t.boxes, "right");
                    var p = a(t.boxes, "top");
                    var g = a(t.boxes, "bottom");
                    var m = a(t.boxes, 'chartArea');
                r(h, !0), r(f, !1), r(p, !0), r(g, !1);
                var v = e - l - u;
                    var b = n - c - d;
                    var y = b / 2;
                    var x = (e - v / 2) / (h.length + f.length);
                    var w = (n - y) / (p.length + g.length);
                    var k = v;
                    var S = b;
                    var C = [];
                i.each(h.concat(f, p, g), (t) => {
                  var e;
                ...
                i.each(h.concat(f), (t) => {
                  var e = i.findNextWhere(C, (e) => {
                      return e.box === t;
                    });
                        var n = {
 left: 0, right: 0, top: D, bottom: F 
};
          ...
          (e.exports = {
            ...
            descriptors: function (t) {
              ...
              var n = [];
                    var r = [];
                    var o = (t && t.config) || {};
                    var s = (o.options && o.options.plugins) || {};
              return (
        ...
        function (t, e, n) {
          ...
          function c(t) {
            var e = r.valueOrDefault;
                var n = i.global;
                var a = e(t.fontSize, n.defaultFontSize);
                var o = e(t.fontStyle, n.defaultFontStyle);
                var s = e(t.fontFamily, n.defaultFontFamily);
            return {
              size: a,
              style: o,
              family: s,
          ...
          (e.exports = a.extend({
            ...
            mergeTicksOptions: function () {
              ...
              for (let e in (!1 === t.minor && (t.minor = { display: !1 }),
 ...
 left: 0, right: 0, top: 0, bottom: 0 
            ...
            calculateTickRotation: function () {
              ...
              if (i.length && t.options.display && t.isHorizontal()) for (
                  var l,
            ...
            fit: function () {
              var t = this;
                    ...
                    var p = c(a);
                    var g = i.gridLines.tickMarkLength;
              if (
                ((e.width = f
                  ? t.isFullWidth()
              ...
              if (a.display && h) {
                var v = r.longestText(t.ctx, p.font, n, t.longestTextCache);
                      var b = r.numberOfLabelLines(n);
                      var y = 0.5 * p.size;
                      var x = t.options.ticks.padding;
                if (f) {
                  t.longestLabelWidth = v;
                  var w = r.toRadians(t.labelRotation);
                        var k = Math.cos(w);
                        var S = Math.sin(w) * v + p.size * b + y * (b - 1) + y;
                  (e.height = Math.min(t.maxHeight, e.height + S + x)),
                  (t.ctx.font = p.font);
                  var C = u(t.ctx, n[0], p.font);
                        var M = u(t.ctx, n[n.length - 1], p.font);
                  0 !== t.labelRotation
                    ? ((t.paddingLeft =                            "bottom" === i.position ? k * C + 3 : k * y + 3),
                    (t.paddingRight =                            "bottom" === i.position ? k * y + 3 : k * M + 3))
                    : ((t.paddingLeft = C / 2 + 3),
                    (t.paddingRight = M / 2 + 3));
                } else a.mirror ? (v = 0) : (v += x + y),
            ...
            getPixelForDecimal: function (t) {
              var e = this;
              if (e.isHorizontal()) {
                var n =                        (e.width - (e.paddingLeft + e.paddingRight)) * t
                        + e.paddingLeft;
                      var i = e.left + Math.round(n);
            ...
            _autoSkip: function (t) {
              var e;
                    ...
                    var l = o.options.ticks.minor;
                    var u = t.length;
                    var c = r.toRadians(o.labelRotation);
                    var d = Math.cos(c);
                    var h = o.longestLabelWidth * d;
                    var f = [];
              for (
            ...
            draw: function (t) {
              ...
              if (n.display) {
                var a = e.ctx;
                      var o = i.global;
                      var s = n.ticks.minor;
                      var u = n.ticks.major || s;
                      var h = n.gridLines;
                      var f = n.scaleLabel;
                      var p = 0 !== e.labelRotation;
                      var g = e.isHorizontal();
                      var m = s.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks();
                      var v = r.valueOrDefault(s.fontColor, o.defaultFontColor);
                      var b = c(s);
                      var y = r.valueOrDefault(u.fontColor, o.defaultFontColor);
                      var x = c(u);
                      var w = h.drawTicks ? h.tickMarkLength : 0;
                      var k = r.valueOrDefault(f.fontColor, o.defaultFontColor);
                      var S = c(f);
                      var C = r.options.toPadding(f.padding);
                      var M = r.toRadians(e.labelRotation);
                      var P = [];
                      var T = e.options.gridLines.lineWidth;
                      var A = "right" === n.position ? e.left : e.right - T - w;
                      var I = "right" === n.position ? e.left + w : e.right;
                      var _ =
                        "bottom" === n.position ? e.top + T : e.bottom - w - T;
                      var D =                        "bottom" === n.position ? e.top + T + w : e.bottom + T;
                if (
                  (r.each(m, (i, a) => {
                  ...
                  var F;
                        ...
                        var L = 0;
                        var R = d(f) / 2;
                  if (g) (F = e.left + (e.right - e.left) / 2),
                    (O =                            "bottom" === n.position
                              ? e.bottom - R - C.bottom
                              : e.top + R + C.top);
                  else {
                ...
                if (h.drawBorder) {
                  ...
                  var z = e.left;
                        ...
                        var E = e.top;
                        var W = e.bottom + T;
                        var B = r.aliasPixel(a.lineWidth);
                  g
              ...
              for (n = 0, i = t.length; n < i; ++n) {
                ...
                if (u && u.hasValue()) {
                  var c = u.getCenterPoint();
                      var d = r.distanceBetweenPoints(e, c);
                  d < l && ((l = d), (a = u));
                }
              }
              if (a) {
          ...
          (e.exports = a.extend({
            ...
            getTitle: function () {
              var t = this._options.callbacks;
                  var e = t.beforeTitle.apply(this, arguments);
                  var n = t.title.apply(this, arguments);
                  var i = t.afterTitle.apply(this, arguments);
                  var a = [];
              return (a = l((a = l((a = l(a, u(e))), u(n))), u(i)));
            },
            ...
            getFooter: function () {
              var t = this._options.callbacks;
                  var e = t.beforeFooter.apply(this, arguments);
                  var n = t.footer.apply(this, arguments);
                  var i = t.afterFooter.apply(this, arguments);
                  var a = [];
              return (a = l((a = l((a = l(a, u(e))), u(n))), u(i)));
            },
            update: function (t) {
              ...
              if (g.length) {
                ...
                var S = [];
                for (e = 0, n = g.length; e < n; ++e) S.push(
                    ((i = g[e]),
                    (a = void 0),
                    (s = void 0),
                    void 0,
                ...
                (p.title = d.getTitle(S, m)),
                (p.beforeBody = d.getBeforeBody(S, m)),
                (p.body = d.getBody(S, m)),
                (p.afterBody = d.getAfterBody(S, m)),
                (p.footer = d.getFooter(S, m)),
                (p.x = Math.round(x.x)),
                (p.y = Math.round(x.y)),
          ...
          (e.exports = a.extend({
            draw: function () {
              var t;
                    ...
                    var l = a.spanGaps;
                    var u = this._children.slice();
                    var c = o.elements.line;
                    var d = -1;
              for (
                ...
                s.lineDashOffset =                        a.borderDashOffset || c.borderDashOffset,
            ...
            draw: function () {
              ...
              if (
                ...
                var c = Math.min(Math.abs(t - e), Math.abs(n - i));
                      var d = (u = u > c ? c : u) / 2;
                      var h = t + ("left" !== o ? d * a : 0);
                      var f = e + ("right" !== o ? -d * a : 0);
                      var p = n + ("top" !== o ? d * r : 0);
                      var g = i + ('bottom' !== o ? -d * r : 0);
                h !== f && ((n = p), (i = g)),
                p !== g && ((t = h), (e = f));
              }
              s.beginPath(),
              ...
              var m = [
                  ...
                  [e, i],
                    ...
                    var v = ['bottom', 'left', 'top', 'right'].indexOf(o, 0);
              function b(t) {
                return m[(v + t) % 4];
              }
              -1 === v && (v = 0);
        ...
        function (t, e, n) {
          ...
          n = e.exports = {
            ...
            drawPoint: function (t, e, n, i, a, r) {
              var o; var s; var l; var u; var c; var 
d;
              if (
                ((r = r || 0),
                !e
        ...
        function (t, e, n) {
          ...
          var i;
              ...
              each: function (t, e, n, i) {
                var r; var o; var 
s;
                if (a.isArray(t)) if (((o = t.length), i)) for (r = o - 1; r >= 0; r--) e.call(n, t[r], r);
                  else for (r = 0; r < o; r++) e.call(n, t[r], r);
                else if (a.isObject(t)) for (o = (s = Object.keys(t)).length, r = 0; r < o; r++) e.call(n, t[s[r]], s[r]);
              },
              arrayEquals: function (t, e) {
                var n; var i; var r; var 
o;
...
o;
      ...
      48: [
        function (t, e, n) {
          ...
          var i = t(46);
              var a = "$chartjs";
              var r = "chartjs-";
              var o = r + "render-monitor";
              var s = r + "render-animation";
              var l = ["animationstart", "webkitAnimationStart"];
              var u = {
          ...
          function g(t, e, n) {
            var u;
                ...
                var f;
                var g = t[a] || (t[a] = {});
                var m = (g.resizer = (function (t) {
                var e = document.createElement('div');
                    var n = r + "size-monitor";
                    var i =                      "position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;";
                (e.style.cssText = i),
                (e.className = n),
            ...
            !(function (t, e) {
              var n = t[a] || (t[a] = {});
                  var r = (n.renderProxy = function (t) {
                  t.animationName === s && e();
                });
              i.each(l, (e) => {
                h(t, e, r);
          ...
          (e.exports = {
            ...
            initialize: function () {
              var t;
                  var e;
                  var n;
                  var i = 'from{opacity:0.99}to{opacity:1}';
              (e =                  "@-webkit-keyframes "
                  + s
                  + "{"
                  + i
            ...
            acquireContext: function (t, e) {
              ...
              return n && n.canvas === t
                ? ((function (t, e) {
                  ...
                  if (i === null || '' === i) if ('' === t.style.height) t.height = t.width / (e.options.aspectRatio || 2);
                    else {
                      var s = c(t, 'height');
                      void 0 !== o && (t.height = s);
                    }
                    ...
                    n(
                      (function (t, e) {
                        var n = u[t.type] || t.type;
                            var a = i.getRelativePosition(t, e);
      ...
      51: [
        function (t, e, n) {
          ...
          function s(t, e, n) {
            ...
            if (((i = parseFloat(r, 10)), isFinite(i) && Math.floor(i) === i)) return (
                ('-' !== r[0] && '+' !== r[0]) || (i = e + i),
                !(i === e || i < 0 || i >= n) && i
              );
            switch (r) {
          ...
          e.exports = {
            ...
            afterDatasetsUpdate: function (t, e) {
              var n;
                  ...
                  var r;
                  var o;
                  var d = (t.data.datasets || []).length;
                  var h = e.propagate;
                  var f = [];
              for (i = 0; i < d; ++i) (o = null),
            ...
            beforeDatasetDraw: function (t, e) {
              ...
              if (n) {
                var a = t.ctx;
                    ...
                    var l = o._children || [];
                    var u = n.mapper;
                    var c = s.backgroundColor || i.global.defaultColor;
                u
                    && c
                    && l.length
                    ...
                    (function (t, e, n, i, a, r) {
                      let o;
                        ...
                        var y = 0;
                        var x = 0;
                      for (t.beginPath(), o = 0, s = g + !!r; o < s; ++o) (c = n((u = e[(l = o % g)]._view), l, i)),
                        (f = d(u)),
                        (p = d(c)),
                        f && p
        ...
        function (t, e, n) {
          ...
          i._set('global', {
            ...
            legendCallback: function (t) {
              var e = [];
              e.push(`<ul class="${  t.id  }-legend">`);
              for (let n = 0; n < t.data.datasets.length; n++) e.push(
                  '<li><span style="background-color:'
          ...
          var u = a.extend({
            ...
            buildLabels: function () {
              var t = this;
                  ...
                  var n = r.callback(e.generateLabels, [t.chart], t) || [];
              e.filter
                  && (n = n.filter((n) => {
            ...
            fit: function () {
              var t = this;
                  ...
                  var o = t.ctx;
                  var s = i.global;
                  var u = r.valueOrDefault;
                  var c = u(n.fontSize, s.defaultFontSize);
                  var d = u(n.fontStyle, s.defaultFontStyle);
                  var h = u(n.fontFamily, s.defaultFontFamily);
                  var f = r.fontString(c, d, h);
                  var p = (t.legendHitBoxes = []);
                  var g = t.minSize;
                  var m = t.isHorizontal();
              if (
                (m
 ...
 left: 0, top: 0, width: a, height: c 
                  ...
                  var y = n.padding;
                      var x = (t.columnWidths = []);
                      var w = n.padding;
                      var k = 0;
                      var S = 0;
                      var C = c + y;
                  r.each(t.legendItems, (t, e) => {
                    var i = l(n, c) + c / 2 + o.measureText(t.text).width;
                    S + C > g.height
                        && ((w += k + n.padding), x.push(k), (k = 0), (S = 0)),
                    (k = Math.max(k, i)),
                    (S += C),
                    (p[e] = {
 left: 0, top: 0, width: i, height: c 
});
                  }),
                  (w += k),
                  x.push(k),
            ...
            draw: function () {
              var t = this;
                  ...
                  var n = e.labels;
                  var a = i.global;
                  var o = a.elements.line;
                  var s = t.width;
                  var u = t.lineWidths;
              if (e.display) {
                var c;
                    var d = t.ctx;
                    var h = r.valueOrDefault;
                    var f = h(n.fontColor, a.defaultFontColor);
                    var p = h(n.fontSize, a.defaultFontSize);
                    var g = h(n.fontStyle, a.defaultFontStyle);
                    var m = h(n.fontFamily, a.defaultFontFamily);
                    var v = r.fontString(p, g, m);
                (d.textAlign = 'left'),
                ...
                (d.font = v);
                var b = l(n, p);
                    var y = t.legendHitBoxes;
                    var x = t.isHorizontal();
                c = x
                  ? {
                    x: t.left + (s - u[0]) / 2,
                    y: t.top + n.padding,
                ...
                r.each(t.legendItems, (i, l) => {
                  ...
                  (function (t, n, i) {
                    if (!(isNaN(b) || b <= 0)) {
                      ...
                      var s = h(i.lineWidth, o.borderWidth) === 0;
                      if (
                        (d.setLineDash
            ...
            handleEvent: function (t) {
              var e = this;
                  var n = e.options;
                  var i = "mouseup" === t.type ? "click" : t.type;
                  var a = !1;
              if ('mousemove' === i) {
                if (!n.onHover) return;
              } else {
              ...
              var r = t.x;
                  var o = t.y;
              if (r >= e.left && r <= e.right && o >= e.top && o <= e.bottom) for (let s = e.legendHitBoxes, l = 0; l < s.length; ++l) {
                  var u = s[l];
                  if (
                    r >= u.left
                      && r <= u.left + u.width
          ...
          var l = a.extend({
            ...
            fit: function () {
              var t = this;
                  ...
                  var n = t.options;
                  var a = n.display;
                  var o = e(n.fontSize, i.global.defaultFontSize);
                  var s = t.minSize;
                  var l = r.isArray(n.text) ? n.text.length : 1;
                  var u = r.options.toLineHeight(n.lineHeight, o);
                  var c = a ? l * u + 2 * n.padding : 0;
              t.isHorizontal()
            ...
            draw: function () {
              ...
              if (a.display) {
                var s;
                    var l;
                    var u;
                    var c = n(a.fontSize, o.defaultFontSize);
                    var d = n(a.fontStyle, o.defaultFontStyle);
                    var h = n(a.fontFamily, o.defaultFontFamily);
                    var f = r.fontString(c, d, h);
                    var p = r.options.toLineHeight(a.lineHeight, c);
                    var g = p / 2 + a.padding;
                    var m = 0;
                    var v = t.top;
                    var b = t.left;
                ...
                var w = a.text;
                if (r.isArray(w)) for (let k = 0, S = 0; S < w.length; ++S) e.fillText(w[S], 0, k, s), (k += p);
          ...
          e.exports = function () {
            var t = i.extend({
              ...
              getPixelForValue: function (t, e) {
                var n;
                    var i = this;
                    var a = i.options.offset;
                    var r = Math.max(i.maxIndex + 1 - i.minIndex - (a ? 0 : 1), 1);
                if (
                  (void 0 !== t
                      && null !== t
                ...
                if (i.isHorizontal()) {
                  var l = i.width / r;
                      var u = l * (e - i.minIndex);
                  return a && (u += l / 2), i.left + Math.round(u);
                }
                var c = i.height / r;
                    var d = c * (e - i.minIndex);
                return a && (d += c / 2), i.top + Math.round(d);
              },
              getPixelForTick: function (t) {
              ...
              getValueForPixel: function (t) {
                var e = this;
                    var n = e.options.offset;
                    var i = Math.max(e._ticks.length - (n ? 0 : 1), 1);
                    var a = e.isHorizontal();
                    var r = (a ? e.width : e.height) / i;
                return (
                  (t -= a ? e.left : e.top),
                  n && (t -= r / 2),
          ...
          e.exports = function (t) {
            var e = {
                  ...
                  if (
                    ...
                    a.each(i, (i, r) => {
                      ...
                      var c = l[u].positiveValues;
                          var d = l[u].negativeValues;
                      n.isDatasetVisible(r)
                          && o(s)
                          && a.each(i.data, (n, i) => {
                            let a = +t.getRightValue(n);
                            isNaN(a)
                              || s.data[i].hidden
                              || ((c[i] = c[i] || 0),
                              (d[i] = d[i] || 0),
                    ...
                    a.each(l, (e) => {
                      var n = e.positiveValues.concat(e.negativeValues);
                            var i = a.min(n);
                            var r = a.max(n);
                      (t.min = t.min === null ? i : Math.min(t.min, i)),
                ...
                getTickLimit: function () {
                  ...
                  if (this.isHorizontal()) t = Math.min(
            ...
            t.LinearScaleBase = a.extend({
              ...
              handleTickRangeOptions: function () {
                ...
                var r = void 0 !== e.min || void 0 !== e.suggestedMin;
                    var o = void 0 !== e.max || void 0 !== e.suggestedMax;
                void 0 !== e.min
                  ? (t.min = e.min)
              ...
              buildTicks: function () {
                var t = this;
                    ...
                    for (let d = 1; d < c; ++d) o.push(Math.round((l + d * r) * a) / a);
            ...
            var e = {
                  ...
                  if (
                    ...
                    i.each(l, (e) => {
                      if (e.length > 0) {
                        var n = i.min(e);
                              var a = i.max(e);
                        (t.min = t.min === null ? n : Math.min(t.min, n)),
                        (t.max = t.max === null ? a : Math.max(t.max, a));
                      }
                    });
                  } else i.each(a, (e, a) => {
                          ...
                          && i.each(e.data, (e, n) => {
                            ...
                            isNaN(i)
                              ...
                              t.max === null
                                ...
                                : i > t.max && (t.max = i),
                              i !== 0 &&
                                (t.minNotZero === null || i < t.minNotZero)
                                && (t.minNotZero = i));
                          });
                    });
                  this.handleTickRangeOptions();
                ...
                buildTicks: function () {
                  var t = this;
                      var e = t.options.ticks;
                      var n = !t.isHorizontal();
                      var a = { min: e.min, max: e.max };
                      var r = (t.ticks = (function (t, e) {
                      var n;
                          var a;
                          var r = [];
                          var o = i.valueOrDefault;
                          var s = o(
                            t.min,
                            Math.pow(10, Math.floor(i.log10(e.min)))
                          );
                          var l = Math.floor(i.log10(e.max));
                          var u = Math.ceil(e.max / Math.pow(10, l));
                      0 === s
                ...
                getPixelForValue: function (e) {
                  var n;
                      ...
                      var s;
                      var l = this;
                      var u = l.options.ticks.reverse;
                      var c = i.log10;
                      var d = l._getFirstTickValue(l.minNotZero);
                      var h = 0;
                  return (
                    (e = +l.getRightValue(e)),
                    u
                    ...
                    e !== r
                        && (r === 0 &&
                          ((n -= h = i.getValueOrDefault(
                            l.options.ticks.fontSize,
                            t.defaults.global.defaultFontSize,
                          )),
                          (r = d)),
                        e !== 0 && (h += (n / (c(o) - c(r))) * (c(e) - c(r))),
                        (a += s * h)),
                    a
                  );
                },
                getValueForPixel: function (e) {
                  var n;
                      ...
                      var o;
                      var s = this;
                      var l = s.options.ticks.reverse;
                      var u = i.log10;
                      var c = s._getFirstTickValue(s.minNotZero);
                  if (
                    (l
                      ? ((a = s.end), (r = s.start))
                      : ((a = s.start), (r = s.end)),
          ...
          e.exports = function (t) {
            ...
            function l(t) {
              var n = t.options.pointLabels;
                  var i = a.valueOrDefault(n.fontSize, e.defaultFontSize);
                  var r = a.valueOrDefault(n.fontStyle, e.defaultFontStyle);
                  var o = a.valueOrDefault(n.fontFamily, e.defaultFontFamily);
              return {
                size: i,
                style: r,
                family: o,
            ...
            function d(t, e, n, i) {
              if (a.isArray(e)) for (let r = n.y, o = 1.5 * i, s = 0; s < e.length; ++s) t.fillText(e[s], n.x, r), (r += o);
            ...
            var p = t.LinearScaleBase.extend({
              setDimensions: function () {
                ...
                var r = a.min([t.height, t.width]);
                    var o = a.valueOrDefault(i.fontSize, e.defaultFontSize);
              ...
              getTickLimit: function () {
                var t = this.options.ticks;
                    var n = a.valueOrDefault(t.fontSize, e.defaultFontSize);
                return Math.min(
...
e;
                this.options.pointLabels.display
                  ? (function (t) {
                    var e;
                          ...
                          var i;
                          var r = l(t);
                          var o = Math.min(t.height / 2, t.width / 2);
                          var c = { r: t.width, l: 0, t: t.height, b: 0 };
                          var d = {};
                    ...
                    for (e = 0; e < g; e++) {
                      ...
                      var m = t.getIndexAngle(e);
                            var v = a.toDegrees(m) % 360;
                            var b = u(v, i.x, n.w, 0, 180);
                            var y = u(v, i.y, n.h, 90, 270);
              ...
              setReductions: function (t, e, n) {
                var i = e.l / Math.sin(n.l);
                    var a = Math.max(e.r - this.width, 0) / Math.sin(n.r);
                    var r = -e.t / Math.cos(n.t);
                    var o = -Math.max(e.b - this.height, 0) / Math.cos(n.b);
                (i = f(i)),
                (a = f(a)),
                (r = f(r)),
                (o = f(o)),
              ...
              setCenterPoint: function (t, e, n, i) {
                var a = this;
                    ...
                    var l = a.height - i - a.drawingArea;
              ...
              draw: function () {
                ...
                if (n.display) {
                  var u = t.ctx;
                      var f = this.getIndexAngle(0);
                      var p = o(r.fontSize, e.defaultFontSize);
                      var g = o(r.fontStyle, e.defaultFontStyle);
                      var m = o(r.fontFamily, e.defaultFontFamily);
                      var v = a.fontString(p, g, m);
                  a.each(t.ticks, (n, l) => {
                    if (l > 0 || r.reverse) {
                        ...
                        (i.display
                            ...
                            && (function (t, e, n, i) {
                              ...
                              if (
                                ...
                                r.moveTo(l.x, l.y);
                                for (let u = 1; u < o; u++) (l = t.getPointPosition(u, n)),
                                  r.lineTo(l.x, l.y);
                  ...
                  (n.angleLines.display || n.pointLabels.display)
                        && (function (t) {
                          ...
                          let u = t.getDistanceFromCenterForValue(
                          ...
                          for (let p = s(t) - 1; p >= 0; p--) {
                            ...
                            if (o.display) {
                              let m = t.getPointPosition(p, u + 5);
                                var v = a.valueAtIndexOrDefault(
                                  o.fontColor,
                                  p,
                                  e.defaultFontColor,
                                );
                              (n.font = f.font), (n.fillStyle = v);
                              let b = t.getIndexAngle(p);
                                var y = a.toDegrees(b);
                              (n.textAlign = c(y)),
      ...
      59: [
        function (t, e, n) {
          ...
          var a = t(26);
              ...
              var o = t(33);
              var s = t(34);
              var l = Number.MIN_SAFE_INTEGER || -9007199254740991;
              var u = Number.MAX_SAFE_INTEGER || 9007199254740991;
              var c = {
                millisecond: {
                  common: !0,
                  size: 1,
          ...
          function b(t, e, n, a) {
            var o;
                ...
                var h = v(l);
                var f = r.valueOrDefault(s.stepSize, s.unitStepSize);
                var p = "week" === l && s.isoWeekday;
                var g = a.ticks.major.enabled;
                var m = c[l];
                var b = i(t);
                var y = i(e);
                var x = [];
          ...
          e.exports = function () {
            var t = o.extend({
              ...
              determineDataLimits: function () {
                ...
                for (t = 0, n = (d.data.datasets || []).length; t < n; ++t) if (d.isDatasetVisible(t)) if (((o = d.data.datasets[t].data), r.isObject(o[0]))) for (x[t] = [], e = 0, a = o.length; e < a; ++e) (s = m(o[e], c)), y.push(s), (x[t][e] = s);
              ...
              buildTicks: function () {
                ...
                return (
                  ...
                  (a._table = (function (t, e, n, i) {
                    ...
                    for (c.push(n), a = 0, r = c.length; a < r; ++a) (l = c[a + 1]),
                      (o = c[a - 1]),
                      (s = c[a]),
                      (void 0 !== o
                            && void 0 !== l
                  ...
                  (a._labelFormat = (function (t, e) {
                    var n;
                        ...
                        var r = t.length;
                    for (n = 0; n < r; n++) {
                      if ((i = g(t[n], e)).millisecond() !== 0) return 'MMM D, YYYY h:mm:ss.SSS a';
                      (i.second() === 0 &&
                          i.minute() === 0 &&
                          i.hour() === 0)
                          || (a = !0);
                  ...
                  (function (t, e) {
                    var n;
                        ...
                        var o;
                        var s = [];
                    for (n = 0, a = t.length; n < a; ++n) (r = t[n]),
                      (o = !!e && r === +i(r).startOf(e)),
              ...
              getLabelForIndex: function (t, e) {
                var n = this.chart.data;
                    ...
                    var a = n.labels && t < n.labels.length ? n.labels[t] : "";
                    var o = n.datasets[e].data[t];
                return (
              ...
              tickFormatFunction: function (t, e, n, i) {
                var a = this.options;
                    ...
                    var l = s[this._unit];
                    var u = this._majorUnit;
                    var c = s[u];
                    var d = t.clone().startOf(u).valueOf();
                    var h = a.ticks.major;
                    var f = h.enabled && u && c && o === d;
                    var p = t.format(i || (f ? c : l));
                    var g = f ? h : a.ticks.minor;
                    var m = r.valueOrDefault(g.callback, g.userCallback);
                return m ? m(p, e, n) : p;
              },
              ...
              getPixelForOffset: function (t) {
                var e = this;
                    var n = e._horizontal ? e.width : e.height;
                    var i = e._horizontal ? e.left : e.top;
                    var a = p(e._table, 'time', t, 'pos');
                return (
                  i
                    + (n * (e._offsets.left + a))
              ...
              getValueForPixel: function (t) {
                var e = this;
                    var n = e._horizontal ? e.width : e.height;
                    var a = e._horizontal ? e.left : e.top;
                    var r =
                      (n ? (t - a) / n : 0) *
                        (e._offsets.left + 1 + e._offsets.left) -
                      e._offsets.right;
                    var o = p(e._table, 'pos', r, 'time');
                return i(o);
              },
              getLabelWidth: function (t) {
                var e = this.options.ticks;
                    var n = this.ctx.measureText(t).width;
                    var i = r.toRadians(e.maxRotation);
                    var o = Math.cos(i);
                    var s = Math.sin(i);
                return (
                  n * o
              ...
              getLabelCapacity: function (t) {
                var e = this;
                    var n = e.options.time.displayFormats.millisecond;
                    var a = e.tickFormatFunction(i(t), 0, [], n);
                    var r = e.getLabelWidth(a);
                    var o = e.isHorizontal() ? e.width : e.height;
        ...
        var n = 1;
          function i() {
            ...
            t(".wow").each(function () {
              ...
              var o = t(this).attr('data-wow-delay');
                if (o) {
          ...
          var i = document.documentElement;
            let a = window.pageYOffset || i.scrollTop || n.scrollTop;
            var r = i.clientTop || n.clientTop || 0;
            let o = e.top + a - r;
            return Math.round(o);
          }
          t(".wow").each(function () {
          ...
          var i = t(this).attr('data-wow-delay');
              i
...
(function (t, e) {
  ...
  "function" === typeof define && define.amd
    ? define([], () => ((t.Waves = e.call(t)), t.Waves))
  ...
  function o(t) {
    ...
    return (
      ...
      (n = (function (t) {
        return (e = t) !== null && e === e.window
          ? t
          : t.nodeType === 9 && t.defaultView;
        var e;
      }(a))),
      {
  ...
  function c(t, e, n) {
    if (n) {
      ...
      var i = n.getAttribute('data-x');
          var a = n.getAttribute("data-y");
          var r = n.getAttribute("data-scale");
          var o = n.getAttribute("data-translate");
          var u = 350 - (Date.now() - Number(n.getAttribute('data-hold')));
...
a;
      ...
      (e = e ? ' ' + e : '');
      for (let o = 0, s = t.length; o < s; o++) (a = (i = t[o]).tagName.toLowerCase()),
...
!(function (t) {
  ...
  let r = function (t) {
    if (t.hasClass("validate")) {
      let e = t.val();
      var n = !e.length;
      var i = !t[0].validity.badInput;
      if (n && i) t.removeClass("valid").removeClass("invalid");
      else {
        const a = t.is(":valid");
        var r = Number(t.attr('length')) || 0;
        a && (!r || r > e.length)
    ...
    n.is('form')
        && (n
          ...
          .each((e, n) => {
            const i = t(n);
            let a = !i.val();
            let r = !i.attr("placeholder");
            a && r && i.siblings('label, i').removeClass('active');
          }),
        n.find('select.initialized').each((e, n) => {
          const i = t(n);
          let a = i.siblings("input.select-dropdown");
          let r = i.children("[selected]").val();
          i.val(r), a.val(r);
        }));
  }),
  ...
  if (!t('.hiddendiv').first().length) {
    const l = t('<div class="hiddendiv common"></div>');
    s.append(l);
  }
...
(function (t) {
  ...
  t('body').on('hidden.bs.modal', '.modal', () => {
    t('body').removeClass('scrollable');
  });
}(jQuery));
let i;
let toggler = document.getElementsByClassName("rotate");
...
!(function (t, e) {
  ...
  let t = {
    ...
    var a = !!window.File;
    var r = function (t) {
      if (t.hasAttribute('multiple') && a) return [].slice
          .call(t.files)
          .map((t) => {
            return t.name;
          })
  ...
  function o() {
    let e = this.parentNode.querySelector(t.CUSTOMFILELABEL);
    if (e) {
      let a = n(e);
        var o = r(this);
